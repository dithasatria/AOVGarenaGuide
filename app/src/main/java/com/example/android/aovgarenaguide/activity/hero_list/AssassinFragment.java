 ...
 */
public class AssassinFragment extends Fragment {
    ...
    private void getDataHero(){
        ...
        final Call<APIResponseSelectHero> apiResponseCall = apiService.getSelectionHeroList(Utility.KEY_ASSASSIN);
