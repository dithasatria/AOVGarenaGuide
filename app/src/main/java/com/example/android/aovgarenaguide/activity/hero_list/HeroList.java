...
public class HeroList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Select Hero");
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    AllHeroFragment tab1 = new AllHeroFragment();
                    return tab1;
                case 1:
                ...
                case 2:
                    ...
                    return tab3;
                case 3:
                    AssassinFragment tab4 = new AssassinFragment();
                    return tab4;
                case 4:
                    MageFragment tab5 = new MageFragment();
                    return tab5;
                case 5:
                    ArcherFragment tab6 = new ArcherFragment();
                    return tab6;
                case 6:
